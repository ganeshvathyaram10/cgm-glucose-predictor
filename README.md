...
> Predicting future blood glucose levels 30 minutes ahead using CGM data and ensemble machine learning.

## Business Problem
People with diabetes need advance warning before their blood glucose becomes dangerously high or low. This project forecasts blood glucose 30 minutes into the future, giving patients time to take corrective action.
...
## Quick Start
git clone https://github.com/yourusername/cgm-glucose-predictor
